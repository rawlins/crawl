...
enum ability_type
{
    ...
    // monster species
    ABIL_MONSTER_SPECIES_1,
    ABIL_MONSTER_SPECIES_2,
    ABIL_MONSTER_SPECIES_3,
    ABIL_MONSTER_SPECIES_4,
    ABIL_MONSTER_SPECIES_5,
    ABIL_MONSTER_SPECIES_6,
    ABIL_MONSTER_SPECIES_7,
    ABIL_MONSTER_SPECIES_8,
    ABIL_MONSTER_SPECIES_9,
    ABIL_MONSTER_SPECIES_10, // TODO: is this enough?
    ABIL_MAX_INTRINSIC = ABIL_MONSTER_SPECIES_10,

    // Evoking items.
    ABIL_EVOKE_BERSERK = 50,
